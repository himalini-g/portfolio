...
Growing up watching Tamil films, the skin tone of the female lead always seemed
 lighter than the male lead even though they’re both South Indian. 
 If we look at the faces found across many Tamil films, are the lighter ones women?
  I investigate this in a systematic way using code. This piece is 
  generated by automatically segmenting faces out of 15 Tamil movies released over
   the last two years. The faces are sorted onto the grid using an estimate of their skin tone.
    Down to up is lighter to darker skin tones and left to right is greyer to saturated skintones.
     I encourage the viewer to look at the grid and draw their own conclusions on whether there is 
     a pattern between gender and skin tone.
`
